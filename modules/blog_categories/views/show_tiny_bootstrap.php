...
<div class="card mb-3">
    ...
    <div class="card-body d-flex gap-2">
        <?= anchor('blog_categories/manage', 'View All Blog Categories', ['class' => 'btn btn-outline-primary']) ?>
        <?= anchor('blog_categories/create/'.$update_id, 'Update Details', ['class' => 'btn btn-primary']) ?>
        <?php 
        $attr_delete = array( 
...
<div class="modal fade" id="delete-modal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open('blog_categories/submit_delete/' . $update_id, ['id' => 'delete-form']) ?>
                    <p>Are you sure?</p>

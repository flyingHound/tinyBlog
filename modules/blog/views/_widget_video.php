<section class="widget-video center" >

    <?php $post_video = $record_obj->youtube; ?>

    <div class="video-responsive video-responsive-16-9">

        <iframe src="https://www.youtube-nocookie.com/embed/<?= $post_video ?>" width="100%" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="">

...
echo '<p class="d-flex gap-2">'.anchor('blog_pictures/create', 'Create New Picture Record', array(
	"class" => "button btn btn-primary", 
	"role" => "button"
));

if(strtolower(ENV) === 'dev') {
    echo anchor('api/explorer/blog_pictures', 'API Explorer', array(
...
<div class="alert alert-danger">
	<h2>Note:</h2>
	<p>For managing Gallery Pictures in your blog, it is advised to use the Picture Gallery functionality provided in the show-view of each Blog Post.</p>
</div>

<?php if (count($rows) > 0): ?>
<div class="table-responsive">
    <table id="results-tbl" class="table table-bordered table-striped table-hover table-sm small">
        <caption class="small">List of Blog Pictures</caption>
            ...
            <tr>
                <th colspan="7">
                    <div class="d-flex justify-content-between py-1 flex-wrap gap-2">
                        <div class="d-flex">
                            <?php
                            echo form_open('blog_pictures/manage/1/', array(
                            	"method" => "get", 
                            	"class" => "me-2"
                            ));

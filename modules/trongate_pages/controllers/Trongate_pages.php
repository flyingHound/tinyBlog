...
class Trongate_pages extends Trongate {
    ...
    private $page_template = 'tiny_blog';
    ...
    public function display(): void {
        ...
        // load additional scripts for frontend editing pages
        if(segment(1) == 'trongate_pages') {
            $additional_includes_top[] = 'css/trongate.css';
            $additional_includes_btm[] = 'js/app.js';

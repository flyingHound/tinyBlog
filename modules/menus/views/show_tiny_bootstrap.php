...
<div class="card mb-3">
    ...
    <div class="card-body d-flex gap-2">
        <?= anchor('menus/manage', 'View All Menus', ['class' => 'btn btn-outline-primary']) ?>
        <?= anchor('menus/create/' . $update_id, 'Update Details', ['class' => 'btn btn-primary']) ?>
        <?php 
        $attr_delete = array( 
...
<div class="row">
	        ...
	        <div class="card-body">
	            <div class="record-details">
	                ...
	                <div class="row detail-row">
	                    ...
	                    <div class="col-8 value"><?= out($description) ?></div>
	                </div>
	                <div class="row detail-row">
    ...
    <div class="col-12 col-mb-6 col-xl-4 mb-3">
    	<?= Modules::run('module_relations/_draw_summary_panel_tbs', 'menu_items', $token) ?>
    </div>
...
<div class="modal fade" id="delete-modal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open('menus/submit_delete/' . $update_id, ['id' => 'delete-form']) ?>
                    <p>Are you sure?</p>
...
document.querySelectorAll('[id^="published-icon"]').forEach(icon => {
    icon.addEventListener('click', (ev) => {
        ...
        fetch(`${baseUrl}api/update/menus/${recordId}`, {
            method: 'PUT',
            headers: {

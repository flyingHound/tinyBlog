...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('blog_sources/manage', 'View All Sources', array("class" => "button alt"));
        echo anchor('blog_sources/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('blog_sources/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Source record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 

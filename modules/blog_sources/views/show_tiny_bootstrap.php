...
<div class="card mb-3">
    ...
    <div class="card-body d-flex gap-2">
        <?= anchor('blog_sources/manage', 'View All Sources', ['class' => 'btn btn-outline-primary']) ?>
        <?= anchor('blog_sources/create/' . $update_id, 'Update Details', ['class' => 'btn btn-primary']) ?>
        <?php 
        $attr_delete = array( 
...
<div class="row">
            ...
            <div class="card-body">
                <div class="record-details">
                    <div class="row detail-row">
                        <div class="col-4 label">Author</div>
                        <div class="col-8 value"><?= out($author) ?></div>
                    </div>
                    <div class="row detail-row">
                        <div class="col-4 label">Website</div>
                        <div class="col-8 value"><?= out($website) ?></div>
                    </div>
                    <div class="row detail-row">
                        <div class="col-4 label">Link</div>
                        <div class="col-8 value"><?= out($link) ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Module Relation Panel -->
    <div class="col-12 col-md-6 col-xl-4 mb-3">
        <?= Modules::run('module_relations/_draw_summary_panel_tbs', 'blog_posts', $token) ?>
    </div>
...
<div class="modal fade" id="delete-modal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= form_open('blog_sources/submit_delete/' . $update_id, ['id' => 'delete-form']) ?>
                    <p>Are you sure?</p>
